...
3. Ditterich von Euler-Donnersperg - Post ID 96
...
### v1.0.10 (February 12, 2026) - Current
- ✅ **Sitemap/robots.txt conflict fix**: Google Search Console reported "blocked by robots.txt" for pages that were in sitemap but disallowed in robots.txt
